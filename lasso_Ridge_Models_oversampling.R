...
### 13600 = double of the higher count class
data_balanced_over <- ovun.sample(Attrition_Flag ~ ., data = data1, method = "over",N =13600)$data
table(data_balanced_over$Attrition_Flag)
x=model.matrix(Attrition_Flag~.,data_balanced_over)[,-1]
dim(x)
y=data_balanced_over$Attrition_Flag
